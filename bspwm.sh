#!/bin/bash
paru -S alacritty bspwm sxhkd feh polybar xorg-xsetroot xorg-xbacklight light picom dunst xfce4-power-manager ksuperkey nerd-fonts-jetbrains-mono pamixer polkit-gnome i3lock-color xrandr maim viewnior nvim fm6000 networkmanager-dmenu-git zsh zsh-autosuggestions zsh-syntax-highlighting oh-my-zsh-git j4-dmenu-desktop --needed --noconfirm
